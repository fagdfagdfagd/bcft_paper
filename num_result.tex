...
\begin{figure}
  ...
  \includegraphics[width=1\columnwidth]{PP_fit.pdf}
    ...
    \label{fig:PPPP}
    \todo[inline]{Mao: Put more points for PP, make the same style, improve quality.}
\end{figure}
...
\todo[inline]{May need to improve the figure quality.}
    \todo[inline]{Mao: Put more points for DN, make the same style, improve quality.}
