...
\end{equation}
for coprime integer $n_1$ and $n_2$ and compactification radii $R_1$ and $R_2$ for the bosons on two sides. This also suggests that connecting two different CFTs will generate an interface whose transmission are determined by the universal parameters of the CFTs on both sides. 
