...
We first deal the three special points $\theta = 0, \frac{\pi}{4}, \frac{\pi}{2}$ and their special relations to the bcc operator ${\rm D} \rightarrow {\rm N}$, and then present a hand-waving argument that the quadratic relation should come from the dimension of the vertex operators. 
...
- Fig. 11 corresponds to the right piece of Fig. 6, but is rotated by 90Â°. This is confusing, in particular since the corresponding Fig. 12 is not rotated. The lambda line on the left has to be dotted. Also confusing is the use of x and L in (E1) below.
