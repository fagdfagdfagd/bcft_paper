...
\end{aligned} \right. 
\end{equation}
where $\lambda = \tan \theta$ and $x = \frac{\theta}{\pi}$. Similarly,
\begin{equation}
\label{eq:PP}
{\rm P} + {\rm P} \rightarrow \lambda + {\rm P} 
\end{equation}
is analyzed to verify
\begin{equation}
\label{eq:result_DNDN}
\mathcal{F} = 
\left\lbrace
\begin{aligned}
\left[\left|x-\frac{1}{4}\right|-\left(x-\frac{1}{4}\right)^2\right]\ln L   &  \quad {\rm fidelity} \\
 2\left[\left|x-\frac{1}{4}\right|-\left(x-\frac{1}{4}\right)^2\right]\ln t  & \quad \text{ Loschmidt echo} \\
\end{aligned} \right. 
\end{equation}
%%% Local Variables:
