...
\end{aligned} \right. 
\end{equation}
As demonstrated in Sec.~\ref{sec_sub:general_formulation}, if we denote $f(k,x<0)\equiv\phi_1$ and $f(k,x>0)\equiv\phi_2$, the boundary condition at the junction reads
...
It is clear that the normalized eigenfunctions in Eq.~\eqref{eq:normalized_f} serves as orthonormal basis in mode expansion. Following the same procedure in Ref.~\onlinecite{di_francesco_conformal_1997}, we have the Hamiltonian as
\begin{equation}
