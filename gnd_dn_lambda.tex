...
The Casimir energy is the vacuum energy brought by the finite size of the setup. From Eq.(\ref{H in gnd_dn_lambda}) and define $x\equiv\theta/\pi$ in Eq.(\ref{Momentum in gnd_dn_lambda}), we have
\begin{equation}
\begin{aligned}
