...
In this appendix, we provide more details for calculating the amplitude $Z_{ab}$ in Sec.~\ref{sec:analytic_numerics}. We started to prove the following identity for a real symmetric matrix $M$
\begin{equation}
